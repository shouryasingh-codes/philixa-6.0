...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        ai_provider=os.getenv("PHILIXA_AI_PROVIDER", "local").lower(),
        ai_model=os.getenv("PHILIXA_AI_MODEL", "local-heuristic-v1"),
        ai_api_key=os.getenv("PHILIXA_AI_API_KEY", ""),
        ai_base_url=os.getenv("PHILIXA_AI_BASE_URL", ""),
